...
<section class="home">
    ...
    <div class='recuadro' id="dos" >
        <h1 style="text-align:center">Halo Infinite</h1><br>
        <p style="text-align:justify">Halo Infinite la onceava entrega para consolas y la décima cuarta entrega en
        ...
        <p style="text-align:justify">Comencemos hablando sobre la campaña de Halo Infinite, la cual no mentían a
        ...
        <p style="text-align:justify">En resumen podemos decir que Halo Infinite es un gran título que sin duda 
        ...
        ser interesante y sobre todo relevante para la saga, también quiero destacar el excelente trabajo 
        artístico que tiene Halo Infnite el cual luce increíble en consolas Xbox ONE S y X así como en consolas 
        Xbox Series S/X, y recuerden que Halo Infinite y el resto de las entregas anteriores de la saga están 
        disponible a través del servicio de Xbox Game Pass así como una gran variedad de juegos.
        </p><br><br><br><br><br><br>
	</div>
    <div class='circulo' id="tres">
        <img src="../img/halo.jpg" class='imagen'>
    </div>
                </hr>
                <hr style="height:5px;border:none;color:#333;background-color:#333;">
    <div class='recuadro' id="tres">
        <h1 style="text-align:center">Gears Of War 5</h1><br>
        <p style="text-align:justify">Esta quinta entrega es el Gears of War más completo, más espectacular y más
         ...
         <p style="text-align:justify">Con una jugabilidad sutilmente mejorada, que hace que sea simplemente 
        ...
        <p style="text-align:justify">Kait, la nueva protagonista, es un personaje complejo y con un interesante 
        ...
        <p style="text-align:justify">Gears 5 es un juego visualmente apabullante, ofreciendo algunos de los 
        momentos más espectaculares de toda la saga, y ya es decir. Ya sea en la One original, a 30fps, o en One 
        X, a 60fps, es uno de esos títulos que exprime al máximo cada hardware, con momentos con decenas de 
        enemigos y explosiones en pantalla que te dejan con la boca abierta
        </p><br><br><br><br><br><br>
	</div>
    <div class='circulo' id="dos">
        <img src="../img/gears.jpg" class='imagen'>
                ...
                <hr style="height:5px;border:none;color:#333;background-color:#333;">
    <div class='recuadro' id="dos">
        <h1 style="text-align:center">Forza Horizon 5</h1><br>
        <p style="text-align:justify">Es el último lanzamiento de la saga para Xbox One, Xbox Series X|S y PC, 
        ...
        duda, ante una de las mejores entregas de la industria de los videojuegos de todo el 2021</p><br>
         <p style="text-align:justify">En Forza Horizon 5 estamos ante el mapa más extenso de la saga. Playground
        ...
        <p style="text-align:justify">El tapiz de escenarios y fondos coloridos es probablemente el más hermoso 
        ...
        <p style="text-align:justify">Sí, Forza Horizon 5 es un videojuego que está repleto de virtudes, pero, 
        sobre todo, es el resultado de un estudio de desarrollo en la cima de su oficio y género, y el mejor 
        título de carreras de mundo abierto que he jugado en mi vida.
        </p><br><br><br><br><br><br>
	</div>
    <div class='circulo' id="tres">
        <img src="../img/forza.jpg" class='imagen'>
    </div>
                </hr>
            <hr style="height:5px;border:none;color:#333;background-color:#333;">
	<div class='recuadro' id="dos">
